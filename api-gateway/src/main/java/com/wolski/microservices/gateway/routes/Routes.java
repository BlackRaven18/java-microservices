package com.wolski.microservices.gateway.routes;
    ...
    public RouterFunction<ServerResponse> productServiceSwaggerRoute() {
        return route("product_service_swagger")
                ...
                .filter(CircuitBreakerFilterFunctions.circuitBreaker("productServiceSwaggerCircuitBreaker",
                        URI.create("forward:/fallbackRoute")))
                .before(rewritePath("/aggregate/product-service/v3/api-docs", "/api-docs"))
                .build();
    }
    ...
    public RouterFunction<ServerResponse> orderServiceSwaggerRoute() {
        return route("order_service_swagger")
                ...
                .filter(CircuitBreakerFilterFunctions.circuitBreaker("orderServiceSwaggerCircuitBreaker",
                        URI.create("forward:/fallbackRoute")))
                .before(rewritePath("/aggregate/order-service/v3/api-docs", "/api-docs"))
                .build();
    }
    ...
    public RouterFunction<ServerResponse> inventoryServiceSwaggerRoute() {
        return route("inventory_service_swagger")
                ...
                .filter(CircuitBreakerFilterFunctions.circuitBreaker("inventoryServiceSwaggerCircuitBreaker",
                        URI.create("forward:/fallbackRoute")))
                .before(rewritePath("/aggregate/inventory-service/v3/api-docs", "/api-docs"))
                .build();
    }
